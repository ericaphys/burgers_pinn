...
<p>For the inviscid case, within the considered time frame (at approximately t=1/pi) a schock wave is expected and therefore numerical instability has to be managed.</p>
